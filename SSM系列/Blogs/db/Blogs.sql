...
CREATE SCHEMA Blogs DEFAULT CHARACTER SET utf8 COLLATE utf8_bin;
use Blogs;
...
(
    ...
    `mytype`      int          NULL DEFAULT NULL,
    `create_time` TIMESTAMP    NULL DEFAULT NULL comment '创号时间',
...
-- ----------------------------
INSERT INTO `t_user`
VALUES (1, '雷金鹏', 'na334910645f5807ec080cbab2cc64113pai',
        'http://59.110.52.102:8080/blog/static/images/blog/321.jpg',
        '2827717859@qq.com',
        'IT_Painter', 1, '2020-03-08 11:42:22');
...
(
    ...
    `update_time`   timestamp    NULL     DEFAULT now() comment '最新时间',
...
4. serializable,严格串行执行，隔离程度最高,并行程度最低，能够避免幻读问题.',
        'http://59.110.52.102:8080/blog/static/images/blog/1005-800x450.jpg', '原创', '1', '事务',
        '2019-09-13 19:27:57', 0, 1, 1, '1,2');
INSERT INTO `t_blog`
VALUES (2, b'1', '## 双重校验锁的弊端\r\n
...
', 'http://59.110.52.102:8080/blog/static/images/blog/1005-800x450.jpg', '原创', '1',
        '双重校验锁的弊端', '2019-09-14 19:27:37', 0, 2, 1, '1,3');
INSERT INTO `t_blog`
VALUES (3, b'1',
        ...
        'http://59.110.52.102:8080/blog/static/images/blog/1005-800x450.jpg', '转载', '1', '计算机网络', '2020-03-13 19:26:05',
        1, 3, 1, '1,4');
INSERT INTO `t_blog`
VALUES (4, b'1', '\r\n##  数组和ArrayList的异同
...
', 'http://59.110.52.102:8080/blog/static/images/blog/1005-800x450.jpg', '原创', '1',
        '数组和ArrayList的异同', '2020-03-13 19:27:15', 0, 2, 1, '1,5,7');
INSERT INTO `t_blog`
VALUES (5, b'1', 'java中的构造方法是一种特殊类型的方法，用于初始化对象。Java构造函数在对象创建时被调用。 它构造值，即提供对象的数据，这是为什么它被称为构造函数。\r\n创建java构造函数的规则构造函数基本上定义了两个规则。它们分别如下：
...
\r\n\r\n\r\n', 'http://59.110.52.102:8080/blog/static/images/blog/1005-800x450.jpg', '转载', '0',
        'Java构造器（构造方法）', '2020-03-14 10:20:34', 8, 2, 1, '1,6');
INSERT INTO `t_blog`
VALUES (6, b'1',
        ...
        'http://59.110.52.102:8080/blog/static/images/blog/1005-800x450.jpg', '转载', '1', 'EFM', '2020-03-13 19:15:34',
        0, 4, 1, '1,8');
INSERT INTO `t_blog`
VALUES (7, b'1', '\r\n### 深拷贝与浅拷贝
...
', 'http://59.110.52.102:8080/blog/static/images/blog/1005-800x450.jpg', '原创', '1', '深拷贝与浅拷贝', now(),
        0, 2, 1, '1,6,9');
INSERT INTO `t_blog`
VALUES (8, b'1', '## 海量数据存储和排序问题\r\n
...
', 'http://59.110.52.102:8080/blog/static/images/blog/user.jpg', '原创', '1', '海量数据存储和排序问题', now(), 0,
        5, 1, '1,2,9');
...
(
    ...
    `parent_comment_id` int          NULL DEFAULT NULL comment '父评论',
  ...
  AUTO_INCREMENT = 1
  ROW_FORMAT = Compact comment '评论';

-- ----------------------------
-- Records of t_comment
-- ----------------------------
INSERT INTO `t_comment`
VALUES (1, 'http://59.110.52.102:8080/blog/static/images/blog/visitor.jpg', '写得不错！', '2020-03-14 13:05:37',
        'martin@163.com', 'martin', 2, NULL, b'0');
INSERT INTO `t_comment`
VALUES (2, 'http://59.110.52.102:8080/blog/static/images/blog/visitor.jpg', '我jio得可以！', '2020-03-14 13:07:27',
        'ludejin@163.com', 'ludejin', 2, 1, b'0');
INSERT INTO `t_comment`
VALUES (3, 'http://59.110.52.102:8080/blog/static/images/blog/visitor.jpg', '阿姨洗铁路', '2020-03-14 13:52:22',
        'martin@163.com', 'martin', 2, 2, b'0');
INSERT INTO `t_comment`
VALUES (4, 'http://59.110.52.102:8080/blog/static/images/blog/visitor.jpg', '是大佬！', '2020-03-14 13:53:06',
        'Mark@163.com', 'Mark', 2, NULL, b'0');
INSERT INTO `t_comment`
VALUES (5, 'http://59.110.52.102:8080/blog/static/images/blog/321.jpg', '我来了！', '2020-03-14 14:04:24',
        'fadeprogramerwzt@163.com', '楼主', 2, NULL, b'1');
INSERT INTO `t_comment`
VALUES (6, 'http://59.110.52.102:8080/blog/static/images/blog/321.jpg', '你是菜逼', '2020-03-14 14:04:50',
        'fadeprogramerwzt@163.com', '楼主', 2, 3, b'1');
