package itpainter.config;

import com.fasterxml.jackson.databind.ObjectMapper;
import itpainter.config.interceptor.LoginInterceptor;
...
import itpainter.config.web.RequestResponseBodyMethodProcessorWrapper;
...
public class SysConfig implements WebMvcConfigurer, InitializingBean{
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(new LoginInterceptor(objectMapper))
                .addPathPatterns("/api/user/**")//**代表多级任意匹配，*代表一级路径匹配
